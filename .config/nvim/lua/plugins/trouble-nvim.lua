...
-- ABOUT: Pretty diagnostics, references, quickfix, and location list
-- LINKS: https://github.com/folke/trouble.nvim
-- NOTE: This provides a beautiful UI for viewing LSP diagnostics, references, and quickfix items
-- ============
