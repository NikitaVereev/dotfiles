-- ============
-- TITLE: Tiny Inline Diagnostic Configuration
-- ABOUT: Beautiful inline LSP diagnostics (replaces default virtual_text)
-- LINKS: https://github.com/rachartier/tiny-inline-diagnostic.nvim
-- NOTE: This plugin replaces native LSP virtual_text diagnostics with prettier inline messages
-- ============
