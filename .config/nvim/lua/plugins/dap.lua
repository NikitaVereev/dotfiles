-- ============
-- TITLE: DAP (Debug Adapter Protocol) Configuration
-- ABOUT: Full-featured debugger for Neovim with UI, Go support, and virtual text
-- LINKS: https://github.com/mfussenegger/nvim-dap
-- ============
