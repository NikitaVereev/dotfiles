...
vim.opt.synmaxcol = 300 -- Syntax highlighting column limit  i
...
-- Set undo dirrectory and ensure it exists
local undodir = "~/.local/share/nvim/undodir" -- Undo dirrectory path
...
vim.opt.modifiable = true -- Allow ediding buffers
vim.opt.encoding = "UTF-8" -- Use UTF-8 encoding
vim.opt.wildmenu = true -- Enable command-line complection menu
vim.opt.wildmode = "longest:full,full" -- Completion mode for command-line
vim.opt.wildignorecase = true -- Case-insensitive tab completion in commands

-- Cursor Settings
vim.opt.guicursor = {
	"n-v-c-sm:block", -- Normal, Visual, Command-line
